      ...
      <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
          <div class="page-title d-flex">
            <h4><i class="icon-cart-add mr-2"></i> <span class="font-weight-semibold">Pay Your electricity Bills</span></h4>
          </div>
        </div>
...
<?php }?>
     ...
     <div class="card border-top-3 border-top-danger rounded-left-0">
        <div class="card-header header-elements-inline">
          <h6 class="card-title font-weight-semibold">Pay Bills</h6>
...
<h2><div id='verify_name'></div><div id="vloading">verifying in progress.. <div class="loader"></div></div></h2>
<br/>
...
$ident_serviceID=strtoupper($ident_row['identifier_serviceID']);
  ...
  ?>
              ...
              <div class="form-group row">
                   <p>Select Meter type:</p>
<div class="col-lg-10">
             <select class="form-control select" name="variation" id="variation" data-dropdown-css-class="bg-purple" data-fouc required>
  <option value="select">Waiting for network selection....</option>
</select>
           
                  </div>   </div>

       <div class="form-group row">
                <label class="col-form-label col-lg-2">Decoder num</label>
                <div class="col-lg-10">
                  <div class="input-group">
<input type="text" name="billersCode" value="" id="billersCode" placeholder="1111111111" class="form-control" required/>
  ...
  <input type="hidden" name="page" id="page" value="electricity"> 
