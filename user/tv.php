      ...
      <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
          <div class="page-title d-flex">
            <h4><i class="icon-cart-add mr-2"></i> <span class="font-weight-semibold">Order For Data</span></h4>
          </div>
        </div>
...
<?php }?>
     ...
     <div class="card border-top-3 border-top-danger rounded-left-0">
        <div class="card-header header-elements-inline">
          <h6 class="card-title font-weight-semibold">Subscribe Your Tv</h6>
...
<input type="text" name="billersCode" value="" id="billersCode" placeholder="1111111111" class="form-control" required/>
  ...
  <input type="hidden" name="page" id="page" value="tv"> 

  <input type="hidden" name="deno" id="deno" value="50"> 
